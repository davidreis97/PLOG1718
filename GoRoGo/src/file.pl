...
playerInput(3,PlayerNo,Est,Linha,Coluna,Tipo,WPieces,WMixed,BPieces,BMixed) :- /* CPU controlled move decision, used if good move available */
...
playerInput(2,1,Est,Linha,Coluna,Tipo,WPieces,WMixed,BPieces,BMixed) :- /* CPU controlled move decision, used by player 1 to protect his pieces*/
        goodMove(0,0,Linha,Coluna,Est,2),
        repeat,
                random(1,4,Tipo),
                pieceAllowed(1,Tipo,WPieces,WMixed,BPieces,BMixed,Est), !.

playerInput(2,2,Est,Linha,Coluna,Tipo,WPieces,WMixed,BPieces,BMixed) :- /* CPU controlled move decision, used by player 2 to protect his pieces*/
...
playerInput(1,PlayerNo,Est,Linha,Coluna,Tipo,WPieces,WMixed,BPieces,BMixed) :- /* CPU controlled move decision, random */
        repeat,
                random(1,4,Tipo),
                pieceAllowed(PlayerNo,Tipo,WPieces,WMixed,BPieces,BMixed,Est), !,
        repeat,
...
play(Player1,Player2,Board,EatenPieces,WPieces,WMixed,BPieces,BMixed,1) :- /*0 if Player controlled, 1 if AI*/
